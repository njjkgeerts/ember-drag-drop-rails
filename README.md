# Ember Drag Drop (for Rails)

Rails package of [Ember Drag Drop](https://github.com/mharris717/ember-drag-drop). Original by 
[Mike Harris](https://github.com/mharris717).

Simple drag and drop addon for your Ember Rails app.

The goal is to allow you to add drag and drop to your app without having to become an expert in the browser's low level
D&D API.
...
When using this addon, you get to work with objects in your domain layer, just like everywhere else in Ember. The only 
two things you need to use are (as you might expect) [Draggable Object](#draggable-object) and 
...
- Rails
- The 'ember-rails' gem
- Ember version 2.0 or higher using the 'ember-source' gem
...
```ruby
gem "ember-drag-drop-rails"
```

Add the following directive to your Javascript manifest file (application.js):

```js
//= require ember-drag-drop
```

For Ember CLI applications, please use [ember-drag-drop](https://github.com/mharris717/ember-drag-drop).
...
## License
Ember Drag Drop by Mike Harris. Rails package by Nick Geerts. Licensed under the MIT license.
