...
EmberDragDrop.DroppableMixin = Ember.Mixin.create({
  ...
  _droppableIsDraggable: function(event) {
    return EmberDragDrop.Droppable._currentDrag && (
        EmberDragDrop.Droppable._currentDrag === event.target ||
        EmberDragDrop.Droppable._currentDrag.contains(event.target)
      );
  },
...
EmberDragDrop.DroppableMixin._currentDrag = null;
window.addEventListener('dragstart', function(event) {
  EmberDragDrop.DroppableMixin._currentDrag = event.target;
}, true);
